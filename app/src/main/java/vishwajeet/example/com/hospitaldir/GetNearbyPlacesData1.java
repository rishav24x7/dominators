...
/**
 * Created by vishw on 13-10-2017.
 */
...
public class GetNearbyPlacesData1 extends AsyncTask<Object, String, String> {
    ...
    protected String doInBackground(Object... params) {
        try {
            ...
            url = (String) params[1];
            DownloadUrl1 downloadUrl1 = new DownloadUrl1();
            googlePlacesData = downloadUrl1.readUrl(url);
    ...
    protected void onPostExecute(String result) {
        ...
        nearbyPlacesList =  dataParser1.parse(result);
